...
export class ValidationService {
  ...
  private static readonly JOI_OPTIONS = {
    abortEarly: true,
    allowUnknown: false,
    context: true,
    convert: true,
  ...
  public static validate = (schema) => {
    ...
    return (ctx, next) => {
      const errors = { query: undefined, body: undefined, params: undefined };
      if (schema.query) {
